...
export class MenuComponent implements OnInit {
  ...
  constructor(private _elementRef: ElementRef,
    ...
    this.USER_ROLES = this._appConfig.USER_ROLES;
    this.tenantType = JSON.parse(sessionStorage.getItem('sessionInfo')).tenantType;

    if (this.tenantType == this.USER_ROLES.tenant) {
      this.menuItems = _menuService.getTenantItems();
    } else {
      this.menuItems = _menuService.getMasterItems();
    }
